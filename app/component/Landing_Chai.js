...
const Landing_Chai = () => {
  return (
    ...
    <div className='flex'>
        ...
        <div className='w-3/4 text-right'><button className='bg-green-400 text-2xl font-light h-10 w-44 caramel-regular rounded-md hover:text-amber-200'>CHAI@20</button></div>
